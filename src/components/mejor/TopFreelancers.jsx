            ...
            {[1, 2, 3].map((i) => (
              <div key={i} className="glass-panel rounded-[2rem] p-6 space-y-4 animate-pulse">
                <div className="flex items-center gap-3">
                  <div className="h-12 w-12 rounded-2xl bg-amber-500/20" />
                  <div className="space-y-1.5 flex-1">
                    <div className="h-4 w-1/2 bg-[var(--border)] rounded-md" />
                    <div className="h-3 w-1/3 bg-amber-500/20 rounded-md" />
                  </div>
                </div>
                <div className="h-8 w-full bg-[var(--border)]/50 rounded-xl" />
