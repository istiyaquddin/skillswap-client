    ...
    <div className="space-y-8 max-w-7xl mx-auto p-4 md:p-6 font-sans">
      ...
      <div className="glass-panel rounded-[2.5rem] p-6 md:p-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6 relative overflow-hidden">
        ...
        <div className="flex items-center gap-3 shrink-0 flex-wrap">
          ...
          <div className="flex items-center gap-2 border border-rose-500/30 bg-rose-500/10 px-4 py-2 rounded-full text-xs font-bold text-rose-400">
      ...
      <div className="glass-panel rounded-[2rem] p-5 flex flex-col md:flex-row gap-4 items-start md:items-center justify-between">
        {/* Search Input */}
        ...
        <div className="flex items-center gap-2 flex-wrap">
          {ROLE_FILTERS.map((r) => (
            <button
              ...
              className={`capitalize rounded-full px-4 py-2 text-xs font-bold border transition-all ${
                roleFilter === r
                ...
                filteredUsers.map((user) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-3">
                          <div className="relative">
                            ...
                            />
                            {!isBlocked && (
                              <span className="absolute -bottom-0.5 -right-0.5 w-3 h-3 rounded-full bg-emerald-500 border-2 border-[var(--surface)]" />
                            )}
                          </div>
                          <div>
                      ...
                      <td className="px-6 py-4">
                        <span
                          className={`inline-flex items-center gap-1.5 rounded-full border px-3 py-1 text-xs font-bold capitalize ${roleColor}`}
                        >
                          {user.role || "Client"}
                        </span>
                      </td>
