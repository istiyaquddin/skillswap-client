    ...
    <section className="relative py-16 md:py-24">
      <div className="relative mx-auto w-[95%] lg:w-[78%]">
        ...
        <div className="mt-14 text-center">
          <Link
            href="/signup"
            className="amber-gradient amber-glow inline-flex items-center gap-2 rounded-full px-8 py-3.5 text-sm font-bold text-white transition-all duration-300 hover:scale-105 active:scale-95"
          >
